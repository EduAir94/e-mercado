...
function Products() {
  ...
  const [data, setData] = useState<{items: Product[], catName?:string}>({items: [], catName: ''});
  ...
  const list = (products:Product[]) => products.map((product) => (
    ...
    return (
      <div>
        ...
        <div className="container">
          <div className="row">
            <Sort count="soldCount" handleSort={handleSort} />
          </div>
          <div className="row">
            <Filter count="soldCount" handleFilter={handleFilter} />
          </div>

...
class LoginForm extends Component<{ router: RouteInterface }, MyState> {
  ...
  render() {
    const { email, password, validatedForm, showPassword } = this.state;
    ...
    return (
      <form
        ...
        noValidate
      >
        <img className="w-100 h-auto" src="./img/login.png" alt="Login" />
          ...
          <div className="form-group mt-3">
            ...
            <div className="d-flex flex-wrap">
              ...
              <button
                ...
                className="btn_show_hide_pass btn btn-primary flex-1"
              >
